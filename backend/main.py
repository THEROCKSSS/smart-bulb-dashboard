...
def audio_reactive_start(device_id: str, body: AudioReactiveStartBody):
    ...
    if sensitivity is None:
        ...
        if sensitivity is None:
            sensitivity = 1.0
    audio_reactive.start_session(c, body.device_index, body.mode, sensitivity,
                                  body.monochrome_hue, body.n_bands, body.min_dwell_ms)
    return {"ok": True, "mode": body.mode, "device_index": body.device_index, "sensitivity": sensitivity}
...
def group_audio_reactive_start(group_id: str, body: GroupAudioReactiveStartBody):
    ...
    audio_reactive.start_group_session(group_id, controllers, body.device_index, body.mode, role_mode,
                                        ...
                                        hue_offsets, brightness_scales, band_assignments,
