...
def test_redact_obj_masks_secret_named_fields_at_any_depth():
    obj = {
        # Synthetic 16-char placeholder, not a real key -- it has to be shaped
        # like one for this test to prove redact_obj actually masks the field.
        # Phase C's scanner landed after this test was written.
        "devices": [{"id": "bulb-1", "local_key": "verysecretkey123", "ip": "10.0.0.11"}],  # nosecret
