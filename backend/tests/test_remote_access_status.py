...
def test_exposure_warnings_default_to_reading_the_real_pin_gate(auth_reset):
    ...
    # Not "87654321" -- Phase A's complexity rules now reject a descending
    # sequence. The value is incidental here; this test is about whether the
    # exposure warning tracks the gate's on/off state.
    remote_auth.enable("wQ7m2xR9kT")
